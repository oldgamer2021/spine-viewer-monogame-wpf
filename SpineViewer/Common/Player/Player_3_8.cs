...
using SpineViewer.Common.Spine_3_8_95;

namespace SpineViewer.Common.Player
{
    public class Player_3_8 : Player
    {
        ...
        public Player_3_8(PlayerInfo info) { Info = info; Props = new PlayerProps(); }
        public Player_3_8(PlayerInfo info, PlayerProps stat) { Info = info; Props = stat; }
        ...
        public override void Initialize(GraphicsDevice gd)
        {
            ...
            _atlas = new Atlas(Info.AtlasFile, new XnaTextureLoader(Info.PremultipliedAlpha, gd));
